...
public class GuiceVertxLauncher extends Launcher {
     ...
     *
     * @param args
     *            the user command line arguments. For supported command line
     *            arguments please see {@link Launcher}.
     */
    ...
    /**
     * Creates injector to be used for verticle creation. This injector instance
     * will be shared by all Verticles.
     *
     * <p>
     * Override this method if you want to customize logic of the injector
     * creation. To add application specific modules to be used by injector,
     * {@link #getModules} method should be overridden instead.
     * </p>
     *
     * @param vertx
     *            Vert.x instance for which injetor will be created.
     * @return Guice inejector instantiated with modules provided by
     *         {@link #getModules} method.
     */
    ...
    /**
     * Gets the collection of the Guice modules to be registered in Guice
     * injector. Override this method to add application specific modules.
     *
     * <p>
     ...
     *
     * @param vertx
     *            Vert.x instance to load modules into.
